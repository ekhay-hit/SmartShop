...
namespace SmartShop.Server.Migrations
{
    ...
    [Migration("20250216171349_UserAddress")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartShop.Shared.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartShop.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartShop.Shared.ProductVariant", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartShop.Shared.Address", b =>
                {
                    b.HasOne("SmartShop.Shared.User", null)
                        .WithOne("Address")
                        .HasForeignKey("SmartShop.Shared.Address", "UserId")
